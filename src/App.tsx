...
const App: React.FC = () => {
    ...
    return (
        <div className="app">
            <Header onShowHome={showHome} onShowPrograms={showPrograms} onShowAbout={showAbout} onShowInsights={showInsights} onShowContact={showContact} onShowPrivacyPolicy={showPrivacyPolicy}/>
